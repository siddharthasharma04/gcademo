function Button_widget2() {
  ...
  this.bindAddFormEvents = function () {
    ...
    $(".button_widget_form").on("submit", function (e) {
      ...
      that.settings.buttonColor = $('.buttonColor').find('.sp-preview-inner').css("background-color");

      if (!(that.settings.buttonColor == that.original_Btn_color)) {
        that.settings.isBtnConfigured = "true";
      }

      that.settings.buttonBorder =  $('.borderColor').find('.sp-preview-inner').css("background-color");
      ...
      that.settings.buttonColorHover = $('.buttonHoverColor').find('.sp-preview-inner').css("background-color");
...
Button_widget2.prototype = Object.create(MainWidget.prototype);