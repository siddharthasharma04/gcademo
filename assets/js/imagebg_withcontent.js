function Imagebgwithcontent() {
    ...
    $("#imagePosition").change(function(){ 
        $("#imagePosition").find("option[value='"+that.settings.imagePosition+"']").removeAttr('selected');
        that.settings.imagePosition =  $(this).children("option:selected").val();
        $("#imagePosition").find("option[value='"+that.settings.imagePosition+"']").attr("selected", "selected");
        $("#imagePosition").attr('value', that.settings.imagePosition);
    });  
    ...
    this.UploadImage = function (ev) {
      ...
      that.settings.imagePosition = $(ev.target).find('#imagePosition').val();
...
Imagebgwithcontent.prototype = Object.create(MainWidget.prototype);
