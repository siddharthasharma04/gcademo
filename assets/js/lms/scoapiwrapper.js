// @(#)SCOAPIWrapper.js	1.4-02/03/06 
// (c) Copyright 2002 Sun Microsystems, Inc.  All Rights Reserved.

// Wrapper functions to a browser-local SCO API.
// These functions find the required browser-local SCO API & provide
// wrapper functions for accessing the API.

// Originally derived from ADL Sample API source code (See below).
...
function doLMSInitialize()
{
   ...
   if (api == null)
   {
	...
	//alert("LMS Initialize called: " + isSCORM2004);
...
function findAPI(win)
{
   ...
   while ((win.API == null) && (win.API_1484_11 == null || win.API_1484_11 == undefined) && (win.parent != null) && (win.parent != win))
   {
      findAPITries++;
   ...
   if((win.API != null || win.API != undefined)){
		//alert("SCORM 1.2 pe kaam kar rahe ho");
		return win.API;
   } else  if(win.API_1484_11 != null || win.API_1484_11 != undefined){
		//alert("SCORM 2004 pe kaam kar rahe ho");
		//ktm.scoData.isSCORM2004 = true;
		isSCORM2004 = true;		
