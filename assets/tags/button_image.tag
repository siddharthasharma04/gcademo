<button_image>
    ...
    <div class="button-align animation_this word_count" id="button_align_{opts.widgetId}" style="text-align:{opts.settings.align}">
        ...
        <a role='button' href="#" tabindex="0" id="button_widget_{opts.widgetId}" class="buttonParent" data-action="{opts.settings.selectbox}" target="{opts.settings.target}" >
