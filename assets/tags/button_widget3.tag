<button_widget3>
    ...
    <div class="button-align animation_this word_count" id="button_align_{opts.widgetId}"  style="text-align:{opts.settings.align}">
        ...
        <div id="button_widget_{opts.widgetId}" class="buttonParent" data-action="{opts.settings.selectbox}" target="{opts.settings.target}">
	...
	if(!$('#editorPage').find('#button_align_'+opts.widgetId).length){
		this.on("mount", function (e) {
		  ...
		  if (opts.settings.buttonShap == "rectangle button") {
			$("#button_widget_" + opts.widgetId).append("<button tabindex=\"0\" class=\"btnWidget\" type=\"button\" \n                data-hover-style=\"background-color:".concat(def_ButtonHoverColor, "!important;\n                border-radius:").concat(opts.settings.buttonRadius, "px; \n                border:").concat(opts.settings.borderWidth, "px ").concat(opts.settings.borderStyle, " ").concat(def_BorderColor, "!important; \n                box-shadow: ").concat(opts.settings.horizontalDistance, "px ").concat(opts.settings.verticalDistance, "px 5px ").concat(opts.settings.spreaddistance, "px #ccc; width:").concat(opts.settings.buttonWidth, "; height:").concat(opts.settings.buttonHeight, ";\" \n                \n                data-nonHover-style=\n                \"background-color:").concat(def_ButtonColor, "!important;  \n                border-radius:").concat(opts.settings.buttonRadius, "px; \n                border: ").concat(opts.settings.borderWidth, "px ").concat(opts.settings.borderStyle, " ").concat(def_BorderColor, "!important; box-shadow: ").concat(opts.settings.horizontalDistance, "px ").concat(opts.settings.verticalDistance, "px 5px ").concat(opts.settings.spreaddistance, "px #ccc; width:").concat(opts.settings.buttonWidth, "; height:").concat(opts.settings.buttonHeight, ";\" \n                \n                style=\"background-color:").concat(def_ButtonColor, "!important;\n                border-radius:").concat(opts.settings.buttonRadius, "px;\n                border: ").concat(opts.settings.borderWidth, "px ").concat(opts.settings.borderStyle, " ").concat(def_BorderColor, "!important; box-shadow: ").concat(opts.settings.horizontalDistance, "px ").concat(opts.settings.verticalDistance, "px 5px ").concat(opts.settings.spreaddistance, "px #ccc; width:").concat(opts.settings.buttonWidth, "; height:").concat(opts.settings.buttonHeight, "; \"> ").concat(opts.settings.name, " \n                </button>\n                <span class=\"btnHoverAnimation\"></span>"));
		  } else if (opts.settings.buttonShap == "square button" || opts.settings.buttonShap == "circle button") {
			$("#button_widget_" + opts.widgetId).append("<button tabindex=\"0\" class=\"btnWidget\" type=\"button\" \n                data-hover-style=\"background-color:".concat(def_ButtonHoverColor, "!important;\n                border-radius:").concat(opts.settings.buttonRadius, "px; \n                border:").concat(opts.settings.borderWidth, "px ").concat(opts.settings.borderStyle, " ").concat(def_BorderColor, "!important; \n                box-shadow: ").concat(opts.settings.horizontalDistance, "px ").concat(opts.settings.verticalDistance, "px 5px ").concat(opts.settings.spreaddistance, "px #ccc; width:").concat(opts.settings.buttonWidth, "; height:").concat(opts.settings.buttonWidth, ";\" \n                \n                data-nonHover-style=\n                \"background-color:").concat(def_ButtonColor, "!important;  \n                border-radius:").concat(opts.settings.buttonRadius, "px; \n                border: ").concat(opts.settings.borderWidth, "px ").concat(opts.settings.borderStyle, " ").concat(def_BorderColor, "!important; box-shadow: ").concat(opts.settings.horizontalDistance, "px ").concat(opts.settings.verticalDistance, "px 5px ").concat(opts.settings.spreaddistance, "px #ccc; width:").concat(opts.settings.buttonWidth, "; height:").concat(opts.settings.buttonWidth, ";\" \n                \n                style=\"background-color:").concat(def_ButtonColor, "!important;\n                border-radius:").concat(opts.settings.buttonRadius, "px;\n                border: ").concat(opts.settings.borderWidth, "px ").concat(opts.settings.borderStyle, " ").concat(def_BorderColor, "!important; box-shadow: ").concat(opts.settings.horizontalDistance, "px ").concat(opts.settings.verticalDistance, "px 5px ").concat(opts.settings.spreaddistance, "px #ccc; width:").concat(opts.settings.buttonWidth, "; height:").concat(opts.settings.buttonWidth, "; \"> ").concat(opts.settings.name, " \n                </button>\n                <span class=\"btnHoverAnimation\"></span>"));
		  }
